...
const bibelvers = [
  ...
  {
    vers: "Salme 23:1",
    tekst: "Herren er min hyrde, jeg mangler ikke noe.",
  },
  {
    vers: "Jesaja 41:10",
    tekst: "Frykt ikke, for jeg er med deg. Se deg ikke engstelig om, for jeg er din Gud.",
  },
  {
    vers: "Matteus 11:28",
    tekst: "Kom til meg, alle dere som strever og har tungt å bære, og jeg vil gi dere hvile.",
  },
  {
    vers: "Johannes 14:27",
    tekst: "Fred etterlater jeg dere. Min fred gir jeg dere, ikke den fred som verden gir.",
  },
  {
    vers: "Klag 3:22–23",
    tekst: "Herrens miskunn er det at det ikke er forbi med oss, for hans barmhjertighet har ikke tatt slutt. Den er ny hver morgen. Din trofasthet er stor.",
  },
];
...
export default function Velkommen() {
  ...
  useEffect(() => {
    if (!document.getElementById("elvanto-script-3724")) {
      ...
      script.src =
        "https://minbetel.elvanto.eu/calendar_embed.js?c[]=904a47d1-5f81-4ad9-a3c6-f9c1a4898461&ca[]=services&events=1&upcoming[count]=1&upcoming[timeframe]=w&max=3&el_id=3724";
      script.async = true;
  ...
  useEffect(() => {
    const fetchPodcast = async () => {
      try {
        ...
        const durationRaw =
          first.getElementsByTagName("itunes:duration")[0]?.textContent || "";
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {dagensVers && (
        <div className="bg-blue-50 border-l-4 border-blue-600 p-4 mb-8 shadow-sm rounded">
          ...
          <p className="text-sm text-right text-blue-800 font-semibold mt-2">
            — {dagensVers.vers}
          </p>
        </div>
      )}
      ...
      <div className="mb-12">
        <div className="flex justify-between items-center mb-4">
          ...
          <a href="/kalender" className="text-blue-600 hover:underline text-sm">
            Vis hele kalenderen
          </a>
        </div>
      ...
      {podcast && (
        <div className="mb-12">
          <div className="flex justify-between items-center mb-4">
            ...
            <a href="/podcast" className="text-blue-600 hover:underline text-sm">
              Vis alle episoder
            </a>
          </div>
      ...
      {shortsVideoIds.length > 0 && (
        <div className="mb-12">
          ...
          <div
            className="cursor-pointer aspect-video rounded shadow overflow-hidden"
          ...
          >
                <div
                    ...
                    {/* Bakgrunnsbilde – først maxres, fallback hqdefault */}
                    <div
